...
function Side_bar_Button({ text, url }: { text: string; url: string }) {
    ...
    return (
        <li
            className=" cursor-default select-none h-[50px] w-[200px] rounded-xl flex flex-row items-center justify-center justify-startbg-slate-600 hover:bg-slate-500"
            onClick={() => {
...
export default function Sidebar_Top() {
    return (
        <div className="w-[100%] h-[50%] bg-slate-700 text-white rounded-3xl pt-1">
            <div className="navigation">
                <ul className="list-none p-0 m-0 flex flex-row items-center justify-evenly">
